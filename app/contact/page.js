...
export default async function Contact() {
  ...
  return (
    <div className=" min-h-screen">
      <h1 className="my-10 text-6xl font-bold m-auto w-full text-center">
        {page.data.title}
      </h1>
      <div className="flex max-w-4xl mx-auto px-4 justify-center items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          <div>
            <h2 className="text-3xl font-bold text-center md:text-right">
              Contactez-Nous
            </h2>
            <div className="mt-6 text-center md:text-right">
              ...
              <div className="mt-6 font-semibold text-center md:text-right">
                Nous ne prenons ni stagiaires, ni alternants pour le moment.
              </div>

              <div className="mt-6 font-bold text-center md:text-right">
                Spline Studio
              </div>
