...
export default function ImageGallery() {
  ...
  return (
    <div className="bg-white px-4 py-8 md:h-screen">
        ...
        {images.map((img) => {
          ...
          return (
            <motion.div
              layout
              key={img.id}
              className="relative min-w-0 overflow-hidden rounded-xl shadow-lg cursor-pointer h-60 md:h-[75vh] w-full transition-all"
